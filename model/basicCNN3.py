...
class modelX():
  def __init__(self):
    ...
    # Layer #
    #########
    self.cnn1 = cnn_relu_maxpool_bn(self.x,self.f1,self.fb1,self.conv_para,self.pool_para,self.bng1,self.bnb1)
    #print self.cnn1.get_shape()
    self.cnn2 = cnn_relu_maxpool_bn(self.cnn1,self.f2,self.fb2,self.conv_para,self.pool_para,self.bng2,self.bnb2)
